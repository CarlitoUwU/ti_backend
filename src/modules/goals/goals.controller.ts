...
export class GoalsController {
  ...
  @ApiResponse({
    status: 201,
    description:
      'Goal successfully created with automatic calculations. Month/year from current date, goal_kwh calculated from estimated_cost and district fee.',
    type: GoalDto,
  })
  ...
  @ApiResponse({
    status: 409,
    description: 'Goal already exists for this user and current month/year',
  })
